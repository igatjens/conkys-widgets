...
function conky_main()
    ...
    local texto = conky_parse("${diskio_read}")
...
function conky_dibujar_grafico( )
    local ancho = conky_window.width - get_graf_margen_derecho(  ) - get_graf_disk_read_margen_izquierdo( )
    ...
    local codigo = "${goto "..get_graf_disk_read_margen_izquierdo( ).."}${voffset 8}${diskiograph_read "..alto_grafico..","..ancho.." }${voffset -8}"
    return codigo
end

...
function conky_main()
    ...
    local texto = conky_parse("${if_up "..dev_LAN.."}${downspeed "..dev_LAN.."}${else}${downspeed "..dev_WiFi.."}${endif}")
...
function conky_dibujar_grafico( )
    local ancho = conky_window.width - get_graf_margen_derecho(  ) - get_graf_red_down_margen_izquierdo( )
    ...
    local codigo = "${goto "..get_graf_red_down_margen_izquierdo( ).."}${voffset 8}${if_up "..dev_LAN.."}${downspeedgraph "..dev_LAN.." "..alto_grafico..","..ancho.." }${else}${downspeedgraph "..dev_WiFi.." "..alto_grafico..","..ancho.." }${endif}${voffset -8}"
    return codigo
end